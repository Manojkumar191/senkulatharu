...
export default function Admin() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-cream to-emerald-100 flex items-center justify-center pt-0 pb-12">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream to-emerald-100 pt-0 pb-8">
